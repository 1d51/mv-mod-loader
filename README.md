...
- Mod loading is **slow**. The first launch after changing the mod list can take a few minutes. You can potentially save your users the trouble of having to wait by including the **diffs**.
